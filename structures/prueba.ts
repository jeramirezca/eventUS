...
export const prueba = () =>{
    ...
    let ev_prueba4 = new Evento(24341,"evento de prueba","2022","2022","lugar","este es un evento de prueba, descripcion xd",creador_prueba,"ingenieria",mar);
    let ev_prueba5= new Evento(772626,"evento de prueba","2022","2022","lugar","este es un evento de prueba, descripcion xd",creador_prueba,"ingenieria",mar);


    const crear=(E:Evento):void=>{
        listaEventos.push(E);
        arbol.insert(E.getId(),listaEventos.indexOf(E));
    }
